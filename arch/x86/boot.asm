...
%include "arch/x86/print/printstr.asm" ; used for printing strings on the screen in 16 bit mode
%include "arch/x86/disk/disk_load.asm" ; used for loading blocks onto the disk
%include "arch/x86/pm/gdt.asm" ; used for defining the Global Decriptor Table
%include "arch/x86/pm/printstrpm.asm" ; used for printing strings in 32 bit mode
%include "arch/x86/pm/switch_to_pm.asm" ; used for switching to 32 bit mode
